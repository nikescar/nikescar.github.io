...
I have no clue why the definition list below is classified as a
different style of definition list than the one above.

Is it the spaces in the term?

:   Maybe it was the multiple line paragraph in the line below that
    caused this?
...
-   Simple lists do not contain multiple paragraphs. That\'s a complex
    list.
...
-   [yahoo](http://www.yahoo.com)
    ...
    -   here is an inner bullet `oh`
        -   one more `with an inline literally`.
            ...
            ::: {.literalinclude language="python" linenos="" lines="1-10"}
...
::: {.hlist columns="2"}
-   ![This is a short caption for a
    figure.](static/yi_jing_01_chien.jpg "fig:")
-   ![This is a long caption for a figure. Lorem ipsum dolor sit amet,
    consectetur adipiscing elit. Donec porttitor dolor in odio posuere,
    vitae ornare libero mattis. In lobortis justo vestibulum nibh
    aliquet, non.](static/yi_jing_01_chien.jpg "fig:")
:::
...
1.  One,
2.  Two.
3.  Three with long text. Lorem ipsum dolor sit amet, consectetur
    adipiscing elit. Sed feugiat sagittis neque quis eleifend. Duis
    rutrum lectus sit amet mattis suscipit.
